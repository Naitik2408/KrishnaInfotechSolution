...
//                 <button
//                   className="w-full text-left ubuntu-bold text-xl px-4 py-2 bg-gray-100 dark:bg-gray-700 dark:text-gray-100 rounded-lg focus:outline-none"
...
//                 >
//                   <div className="p-4 bg-white dark:bg-gray-300 shadow-md rounded-lg">
//                     {faq.answer}
//                   </div>
//                 </div>
//               </div>
            ...
            {faqData.map((faq, index) => (
              <div key={index} className="mb-4">
                ...
                <div
                  ...
                  className="overflow-hidden"
                >
                  <div className="p-4 bg-white dark:bg-gray-900 dark:text-gray-100 shadow-md rounded-lg">
                    {faq.answer}
                  </div>
                </div>
              </div>
