...
function Services2() {
    return (
        <section id="servicesSection" className="py-12 md:py-24 my-12 px-5 md:my-20">
            ...
            <div className='flex flex-col gap-12'>
                ...
                <div>
                    <div>
                        ...
                        <div className='font-semibold text-gray-600 md:w-96 mt-2'>Discover the latest models and top brands for performance and reliability</div>
                    </div>
                ...
                <div>
                    <div>
                        ...
                        <div className='font-semibold text-gray-600 md:w-96 mt-2'>Our experienced technicians can repair any issue with your laptop, from hardware to software problems.</div>
                    </div>
                    <div className='flex justify-between mt-10'>
                        <div className='md:w-[70%] w-full  flex flex-col gap-4'>
                            <div className='flex gap-5 items-center text-4xl bg-gray-100 p-2 rounded-lg'>
                ...
                <div>
                    <div>
                        ...
                        <div className='font-semibold text-gray-600 md:w-96 mt-2'>Find essential accessories to enhance your laptop experience and productivity.</div>
                    </div>
                    <div className='flex justify-between mt-10'>
                        <div className='md:w-[70%] w-full  flex flex-col gap-4'>
                            <div className='flex gap-5 items-center text-4xl bg-gray-100 p-2 rounded-lg'>
